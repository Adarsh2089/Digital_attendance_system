...
public class Teacher2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(Teacher2.this,R.color.green));
        ...
        SaveAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Teacher2.this,login.class);
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://digital-attendance-syste-c9e49-default-rtdb.asia-southeast1.firebasedatabase.app");
        DatabaseReference databaseReference = database.getReference("C Programming").child(currentDateTime);
